...
sed -i '13s/5.15/5.10/g' target/linux/x86/Makefile
...
# git clone https://github.com/kongfl888/luci-app-adguardhome.git feeds/luci/applications/luci-app-adguardhome
